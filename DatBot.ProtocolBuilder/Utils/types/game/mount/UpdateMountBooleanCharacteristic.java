...
public class UpdateMountBooleanCharacteristic extends UpdateMountCharacteristic {
	public static final int ProtocolId = 538;
	...
	public UpdateMountBooleanCharacteristic(boolean value){
		this.value = value;
	}
