...
public class ObjectItemToSellInHumanVendorShop extends Item {
	...
	public long getPublicPrice() { return this.publicPrice; }
	public void setPublicPrice(long publicPrice) { this.publicPrice = publicPrice; };

	public ObjectItemToSellInHumanVendorShop(){
	}

	public ObjectItemToSellInHumanVendorShop(int objectGID, List<ObjectEffect> effects, int objectUID, int quantity, long objectPrice, long publicPrice){
