...
public class TaxCollectorMovement extends NetworkMessage {
	...
	public TaxCollectorMovement(int movementType, TaxCollectorBasicInformations basicInfos, long playerId, String playerName){
