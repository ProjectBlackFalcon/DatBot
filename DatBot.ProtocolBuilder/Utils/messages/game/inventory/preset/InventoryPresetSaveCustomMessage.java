...
public class InventoryPresetSaveCustomMessage extends AbstractPresetSaveMessage {
	...
	private List<Integer> itemsPositions;
	private List<Integer> itemsUids;

	public List<Integer> getItemsPositions() { return this.itemsPositions; };
	public void setItemsPositions(List<Integer> itemsPositions) { this.itemsPositions = itemsPositions; };
	public List<Integer> getItemsUids() { return this.itemsUids; };
	public void setItemsUids(List<Integer> itemsUids) { this.itemsUids = itemsUids; };
