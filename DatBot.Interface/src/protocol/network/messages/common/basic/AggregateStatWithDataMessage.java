...
import protocol.network.messages.common.basic.AggregateStatMessage;
import protocol.network.types.common.basic.StatisticData;

@SuppressWarnings("unused")
public class AggregateStatWithDataMessage extends AggregateStatMessage {
	...
	//private void append(){
		//for(StatisticData a : datas) {
			//Network.appendDebug("datas : " + a);
		//}
	//}
}
