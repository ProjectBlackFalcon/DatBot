...
public class DareCreatedListMessage extends NetworkMessage {
	...
	//private void append(){
		//for(DareInformations a : daresFixedInfos) {
			//Network.appendDebug("daresFixedInfos : " + a);
		//}
		//for(DareVersatileInformations a : daresVersatilesInfos) {
			//Network.appendDebug("daresVersatilesInfos : " + a);
		//}
	//}
}
