...
public class DareCreationRequestMessage extends NetworkMessage {
	...
	//private void append(){
		...
		//Network.appendDebug("delayBeforeStart : " + this.delayBeforeStart);
		//Network.appendDebug("duration : " + this.duration);
		//Network.appendDebug("isPrivate : " + this.isPrivate);
		//Network.appendDebug("isForGuild : " + this.isForGuild);
		//Network.appendDebug("isForAlliance : " + this.isForAlliance);
