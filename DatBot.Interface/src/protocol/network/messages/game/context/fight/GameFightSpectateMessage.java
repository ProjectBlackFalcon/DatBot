...
public class GameFightSpectateMessage extends NetworkMessage {
	...
	//private void append(){
		//for(FightDispellableEffectExtendedInformations a : effects) {
			//Network.appendDebug("effects : " + a);
		//}
		//for(GameActionMark a : marks) {
			//Network.appendDebug("marks : " + a);
		//}
		//Network.appendDebug("gameTurn : " + this.gameTurn);
		//Network.appendDebug("fightStart : " + this.fightStart);
		//for(Idol a : idols) {
			//Network.appendDebug("idols : " + a);
		//}
	//}
}
