...
public class GameFightSynchronizeMessage extends NetworkMessage {
	...
	//private void append(){
		//for(GameFightFighterInformations a : fighters) {
			//Network.appendDebug("fighters : " + a);
		//}
	//}
}
