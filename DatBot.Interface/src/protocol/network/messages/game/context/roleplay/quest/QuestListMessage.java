...
public class QuestListMessage extends NetworkMessage {
	...
	public List<Integer> finishedQuestsIds;
	public List<Integer> finishedQuestsCounts;
	public List<QuestActiveInformations> activeQuests;
	public List<Integer> reinitDoneQuestsIds;
	...
	//private void append(){
		//for(Integer a : finishedQuestsIds) {
			//Network.appendDebug("finishedQuestsIds : " + a);
		//}
		//for(Integer a : finishedQuestsCounts) {
			//Network.appendDebug("finishedQuestsCounts : " + a);
		//}
		//for(QuestActiveInformations a : activeQuests) {
			//Network.appendDebug("activeQuests : " + a);
		//}
		//for(Integer a : reinitDoneQuestsIds) {
			//Network.appendDebug("reinitDoneQuestsIds : " + a);
		//}
	//}
}
