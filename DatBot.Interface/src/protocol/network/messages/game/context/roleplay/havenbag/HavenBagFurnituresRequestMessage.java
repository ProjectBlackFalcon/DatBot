...
public class HavenBagFurnituresRequestMessage extends NetworkMessage {
	...
	//private void append(){
		//for(Integer a : cellIds) {
			//Network.appendDebug("cellIds : " + a);
		//}
		//for(Integer a : funitureIds) {
			//Network.appendDebug("funitureIds : " + a);
		//}
		//for(Integer a : orientations) {
			//Network.appendDebug("orientations : " + a);
		//}
	//}
}
