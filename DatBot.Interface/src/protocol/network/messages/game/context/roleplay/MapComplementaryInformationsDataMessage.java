...
public class MapComplementaryInformationsDataMessage extends NetworkMessage {
	...
	//private void append(){
		...
		//for(HouseInformations a : houses) {
			//Network.appendDebug("houses : " + a);
		//}
		//for(GameRolePlayActorInformations a : actors) {
			//Network.appendDebug("actors : " + a);
		//}
		//for(InteractiveElement a : interactiveElements) {
			//Network.appendDebug("interactiveElements : " + a);
		//}
		//for(StatedElement a : statedElements) {
			//Network.appendDebug("statedElements : " + a);
		//}
		//for(MapObstacle a : obstacles) {
			//Network.appendDebug("obstacles : " + a);
		//}
		//for(FightCommonInformations a : fights) {
			//Network.appendDebug("fights : " + a);
		//}
		//Network.appendDebug("hasAggressiveMonsters : " + this.hasAggressiveMonsters);
