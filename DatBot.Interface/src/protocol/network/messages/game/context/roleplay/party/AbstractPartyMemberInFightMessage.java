...
public class AbstractPartyMemberInFightMessage extends AbstractPartyMessage {
	public static final int ProtocolId = 6825;
	...
	public AbstractPartyMemberInFightMessage(int reason, long memberId, int memberAccountId, String memberName, int fightId, int timeBeforeFightStart){
		this.reason = reason;
