...
public class DungeonPartyFinderRegisterSuccessMessage extends NetworkMessage {
	...
	public List<Integer> dungeonIds;

	public DungeonPartyFinderRegisterSuccessMessage(){
	}

	public DungeonPartyFinderRegisterSuccessMessage(List<Integer> dungeonIds){
	...
	//private void append(){
		//for(Integer a : dungeonIds) {
			//Network.appendDebug("dungeonIds : " + a);
		//}
	//}
}
