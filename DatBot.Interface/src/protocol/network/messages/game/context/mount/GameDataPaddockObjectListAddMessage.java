...
public class GameDataPaddockObjectListAddMessage extends NetworkMessage {
	...
	//private void append(){
		//for(PaddockItem a : paddockItemDescription) {
			//Network.appendDebug("paddockItemDescription : " + a);
		//}
	//}
}
