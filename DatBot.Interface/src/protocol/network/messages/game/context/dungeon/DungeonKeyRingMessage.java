...
public class DungeonKeyRingMessage extends NetworkMessage {
	...
	public List<Integer> availables;
	public List<Integer> unavailables;
	...
	//private void append(){
		//for(Integer a : availables) {
			//Network.appendDebug("availables : " + a);
		//}
		//for(Integer a : unavailables) {
			//Network.appendDebug("unavailables : " + a);
		//}
	//}
}
