...
import protocol.network.NetworkMessage;
import protocol.network.types.game.guild.tax.TaxCollectorMovement;
...
public class TaxCollectorMovementsOfflineMessage extends NetworkMessage {
	...
	public void Deserialize(DofusDataReader reader) {
		try {
			...
			int _loc3_  = 0;
			this.movements = new ArrayList<TaxCollectorMovement>();
			while( _loc3_ <  _loc2_){
				TaxCollectorMovement _loc15_ = new TaxCollectorMovement();
	...
	//private void append(){
		//for(TaxCollectorMovement a : movements) {
