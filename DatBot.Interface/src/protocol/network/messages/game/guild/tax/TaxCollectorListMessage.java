...
public class TaxCollectorListMessage extends AbstractTaxCollectorListMessage {
	...
	//private void append(){
		//Network.appendDebug("nbcollectorMax : " + this.nbcollectorMax);
		//for(TaxCollectorFightersInformation a : fightersInformations) {
			//Network.appendDebug("fightersInformations : " + a);
		//}
	//}
}
