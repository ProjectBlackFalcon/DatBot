...
public class GuildInformationsPaddocksMessage extends NetworkMessage {
	...
	//private void append(){
		//Network.appendDebug("nbPaddockMax : " + this.nbPaddockMax);
		//for(PaddockContentInformations a : paddocksInformations) {
			//Network.appendDebug("paddocksInformations : " + a);
		//}
	//}
}
