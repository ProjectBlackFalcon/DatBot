...
public class PresetDeleteResultMessage extends NetworkMessage {
	public static final int ProtocolId = 6748;
	...
	public PresetDeleteResultMessage(int presetId, int code){
