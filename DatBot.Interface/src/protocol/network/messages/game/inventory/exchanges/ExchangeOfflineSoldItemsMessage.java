...
public class ExchangeOfflineSoldItemsMessage extends NetworkMessage {
	...
	//private void append(){
		//for(ObjectItemGenericQuantityPrice a : bidHouseItems) {
			//Network.appendDebug("bidHouseItems : " + a);
		//}
		//for(ObjectItemGenericQuantityPrice a : merchantItems) {
			//Network.appendDebug("merchantItems : " + a);
		//}
	//}
}
