...
public class AchievementDetailedListMessage extends NetworkMessage {
	...
	//private void append(){
		//for(Achievement a : startedAchievements) {
			//Network.appendDebug("startedAchievements : " + a);
		//}
		//for(Achievement a : finishedAchievements) {
			//Network.appendDebug("finishedAchievements : " + a);
		//}
	//}
}
