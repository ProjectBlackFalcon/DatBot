...
public class TeleportDestinationsListMessage extends NetworkMessage {
	...
	public List<Integer> subAreaIds;
	public List<Integer> costs;
	public List<Integer> destTeleporterType;
	...
	//private void append(){
		...
		//for(Double a : mapIds) {
			//Network.appendDebug("mapIds : " + a);
		//}
		//for(Integer a : subAreaIds) {
			//Network.appendDebug("subAreaIds : " + a);
		//}
		//for(Integer a : costs) {
			//Network.appendDebug("costs : " + a);
		//}
		//for(Integer a : destTeleporterType) {
			//Network.appendDebug("destTeleporterType : " + a);
		//}
	//}
}
