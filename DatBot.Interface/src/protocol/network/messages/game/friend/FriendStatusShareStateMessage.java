...
public class FriendStatusShareStateMessage extends NetworkMessage {
	public static final int ProtocolId = 6823;
	...
	public FriendStatusShareStateMessage(boolean share){
		this.share = share;
	}
