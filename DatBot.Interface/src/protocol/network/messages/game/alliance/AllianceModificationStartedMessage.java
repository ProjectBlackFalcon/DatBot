...
public class AllianceModificationStartedMessage extends NetworkMessage {
	...
	//private void append(){
		//Network.appendDebug("canChangeName : " + this.canChangeName);
		//Network.appendDebug("canChangeTag : " + this.canChangeTag);
		//Network.appendDebug("canChangeEmblem : " + this.canChangeEmblem);
	//}
}
