...
public class GameFightEntityInformation extends GameFightFighterInformations {
	public static final int ProtocolId = 551;
	...
	public GameFightEntityInformation(int entityModelId, int level, double masterId){
