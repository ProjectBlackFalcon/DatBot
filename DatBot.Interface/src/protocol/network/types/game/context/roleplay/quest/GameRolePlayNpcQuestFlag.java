...
public class GameRolePlayNpcQuestFlag extends NetworkMessage {
	...
	public List<Integer> questsToValidId;
	public List<Integer> questsToStartId;
	...
	//private void append(){
		//for(Integer a : questsToValidId) {
			//Network.appendDebug("questsToValidId : " + a);
		//}
		//for(Integer a : questsToStartId) {
			//Network.appendDebug("questsToStartId : " + a);
		//}
	//}
}
