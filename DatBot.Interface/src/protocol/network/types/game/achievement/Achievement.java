...
public class Achievement extends NetworkMessage {
	...
	//private void append(){
		...
		//for(AchievementObjective a : finishedObjective) {
			//Network.appendDebug("finishedObjective : " + a);
		//}
		//for(AchievementStartedObjective a : startedObjectives) {
			//Network.appendDebug("startedObjectives : " + a);
		//}
	//}
}
