	...
	public String getToSell(){
		...
		for (int i = 0; i < itemsToSell.size(); i++) {
			if (i == itemsToSell.size() - 1) {
				str += "[" + "\"" + DisplayInfo.cleanString(GameData.getItemName(itemsToSell.get(i).getObjectGID())) + "\"" +  "," + itemsToSell.get(i).getObjectGID() + ","
						+ itemsToSell.get(i).getQuantity() + "," + itemsToSell.get(i).getObjectPrice()+ "]";
			} else {
				str += "[" + "\"" + DisplayInfo.cleanString(GameData.getItemName(itemsToSell.get(i).getObjectGID())) + "\"" + "," + itemsToSell.get(i).getObjectGID() + ","
						+ itemsToSell.get(i).getQuantity() + "," + itemsToSell.get(i).getObjectPrice() + "],";
			}
